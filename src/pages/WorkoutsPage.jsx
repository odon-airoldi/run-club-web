    ...
    return (
        <div className="">
            <div className="text-center mb-8">
                ...
                <div className="flex justify-center gap-1 uppercase text-xs text-mauve-400 mt-4">
                    <div>Ordina per</div>
                    <select className="uppercase" value={sortOption} onChange={(e) => setSortOption(e.target.value)}>
